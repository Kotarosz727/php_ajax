  ...
  <body>  
    <div class="container">
      ...
      <div class="table-responsive">
        ...
        <div align="right"><input type="hidden" id="is_active_group_chat_window" value="no" />
        <button type="button" name="group_chat" id="group_chat" class="btn btn-warning btn-xs">Group Chat</button></div>
      </div>
      <!-- group chat -->
      <div>
